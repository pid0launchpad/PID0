...
export default function VerifiedMarket(){
 ...
 return <main className="main-panes verified-market">
  ...
  <Pane title="PROJECT :: ZUNON" meta={sync} className="project-pane pid0-profile pid0-plain verified-project">
   <div className="pid0-scroll">
    ...
    <div className="pid0-token-card">
     <div className="pid0-token-card-head"><b>$ZUNON TOKEN</b><span>CA PENDING</span></div>
    ...
    <div className="pid0-lead">ZUNON lets an external Agent prove control of its declared wallet, request a contract-simulated PONS V2 launch, sign from its own runtime and register the result only after the chain emits a matching launch event.</div>
