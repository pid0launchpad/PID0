...
const fixed=[
 {id:'zunon',token:'NODIUM',ticker:'NODIUM',type:'OFFICIAL PROJECT TOKEN',status:'OFFICIAL PONS VERIFIED',agent:'NODIUM NETWORK',network:'ROBINHOOD CHAIN / 4663',contract:'0x81a0b06eC6e0Db2A8013Dc851F7D46882a86Fc1c',curve:'0x9571e34922aAD0942fc48ec78CDf38F0d33621c4',pairToken:ZERO_ADDRESS,pairLabel:'NATIVE ETH',txHash:'0xc34e7d78e7e6d9d8d75e5b509158675004a69031a1906bc4039fbe8ca7d27eb3',launchBlock:'69910056',liquidity:'',holders:'',description:'$NODIUM is the official token of the NODIUM Agent launchpad and development network. Its PONS V2 TokenLaunched event, token, curve, deployer and native-ETH pair are verified on Robinhood Chain.',proof:'OFFICIAL PONS TOKENLAUNCHED EVENT VERIFIED'},
...
export default function VerifiedMarket(){
 ...
 return <main className="main-panes verified-market">
  ...
  <Pane title="TOKEN REGISTRY :: NODIUM" meta={Math.max(0,records.length-3)+' AGENT / 2 TEST VERIFIED / OFFICIAL VERIFIED'} className="list-pane token-list verified-registry">
   ...
   <div className="market-summary verified-summary"><span>VERIFIED RECORDS <b>{String(records.length).padStart(2,'0')}</b></span><span>$NODIUM OFFICIAL CA <b>PONS VERIFIED</b></span><span>TEST PONS EVENTS <b>02 VERIFIED</b></span><span>SYNC STATE <b>{sync}</b></span></div>
   <div className="pane-foot">OFFICIAL $NODIUM PONS EVENT VERIFIED / TEST 01 + TEST 02 VERIFIED</div>
  </Pane>
  ...
  <Pane title="PROJECT :: NODIUM" meta={sync} className="project-pane zunon-profile zunon-plain verified-project">
   <div className="zunon-scroll">
    ...
    <div className="zunon-token-card">
     <div className="zunon-token-card-head"><b>$NODIUM TOKEN</b><span>CA PUBLISHED</span></div>
     ...
     <p>The official $NODIUM launch is verified against the PONS V2 TokenLaunched event on Robinhood Chain. The contract and launch transaction links above provide independent onchain proof.</p>
    </div>
